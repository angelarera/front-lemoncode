...
import { WeeklyPlan, FavouritesList, MealModal, WeeklySummary, Navigation } from '@/components'
  ...
  <div class="min-h-screen bg-gray-50">
    <main class="mx-auto max-w-[1600px] px-4 py-8 sm:px-6 lg:px-8">
      <div class="flex flex-col lg:flex-row gap-8">
        <section id="weekly-plan" class="weekly-calendar lg:w-3/5 xl:w-4/5">
        ...
        <aside class="favourite-meals lg:w-2/5 xl:w-1/5">
          <div id="favourites" class="favourite-meals mb-5">
          ...
          <div id="summary" class="weekly-summary-section">
